...
<body>
    <div class="body-wrapper">
                                ...
                                <ul class="ht-menu">
                                    ...
                                    <li>
                                        ...
                                        <div class="ht-setting-trigger"><span>Xin chào,
                                                <?php echo e(Auth::user()->username); ?></span></div>
                                        <div class="setting ht-setting">
                                            <ul class="ht-setting-list">
                        ...
                        <div class="col-lg-9 pl-0 ml-sm-15 ml-xs-15">
                            ...
                            <form action="/customer/search" method="GET" class="hm-searchbox">
                                <select name="typecode" class="nice-select select-search-category">
                                    ...
                                    <option value="<?php echo e($type->typecode); ?>"><?php echo e($type->typename); ?></option>
                            ...
                            <div class="header-middle-right">
                                <ul class="hm-menu">
                                    <li class="hm-minicart">
                                        <div class="hm-minicart-trigger">
                                            <span class="item-icon"></span>
                                            <span class="item-text"><?php echo e(number_format(session()->get('carts')['total'])); ?>

                                                VND
                                                <span class="cart-item-count"><?php echo e(count(session()->get('carts')) - 1); ?></span>
                                            </span>
                                        </div>
                                        <span></span>
                                        <div class="minicart">
                                            <ul class="minicart-product-list">
                                                ...
                                                <?php if($key != 'total'): ?>
                                                <li>
                                                    <a href="/customer/product-details/<?php echo e($productInCart['info']->productcode); ?>" class="minicart-product-image">
                                                        <img src="<?php echo e($productInCart['info']->picturelink); ?>" alt="cart products">
                                                    </a>
                                                    <div class="minicart-product-details">
                                                        <h6><a href="/customer/product-details/<?php echo e($productInCart['info']->productcode); ?>"><?php echo e($productInCart['info']->productname); ?></a>
                                                        </h6>
                                                        <span><?php echo e(number_format($productInCart['info']->price*(1-$productInCart['info']->discount/100))); ?>

                                                            x <?php echo e($productInCart['quantity']); ?></span>
                                                    </div>
                                                    <button class="close" title="Xóa">
                                                        <a href="#" onclick="deleteCart('/customer/delete-cart?code=<?php echo e($productInCart['info']->productcode); ?>')">
                                            ...
                                            <p class="minicart-total">Tổng thanh toán:
                                                <span><?php echo e(number_format(session()->get('carts')['total'])); ?>
                                    ...
                                    <nav>
                                        <ul>
                                            ...
                                            <li class="dropdown-holder"><a class="purehealth_drop_menu" href="#">Phân
                                                ...
                                                <ul class="hb-dropdown">
                                                    <?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><a href="/customer/type/<?php echo e($type->typecode); ?>"><?php echo e($type->typename); ?></a>
                                                    </li>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </ul>
                                            </li>
                                            <li class="dropdown-holder"><a class="purehealth_drop_menu" href="#">Tư vấn
                                                    công nghệ AI</a>
                                                <ul class="hb-dropdown">
                                                    <li><a href="<?php echo e($poelink); ?>">Tư vấn Poe (Sử dụng tài khoản google)</a>
                                                    </li>
        ...
        <div class="footer">
            ...
            <?php echo $__env->yieldContent('quickView'); ?>
        </div>
        <?php echo $__env->make('customer.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <?php echo $__env->yieldContent('fixjQuery'); ?>
</body>

</html><?php /**PATH /workspaces/codespaces-blank/PureHealthTTLaravelEC/resources/views/customer/main.blade.php ENDPATH**/ ?>