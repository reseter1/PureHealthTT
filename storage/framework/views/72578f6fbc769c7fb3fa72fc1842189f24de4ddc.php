...
?>
<div class="container">
    <h3>Thanh toán đơn hàng <?php echo e($order->ordercode); ?> </h3>
    ...
    <div class="table-responsive">
        <form action="/vnpay_php/vnpay_create_payment.php" id="create_form" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" name="amount" type="number" value="<?php echo e(($order->total)); ?>" readonly>
            </div>
            <div class="form-group">
                <label for="order_desc">Nội dung thanh toán</label>
                <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2"
                    readonly><?php echo e($order->ordercode); ?></textarea>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="txt_billing_fullname" name="txt_billing_fullname" type="text"
                    value="<?php echo e($order->receivername); ?>" readonly />
            </div>
            <div class="form-group">
                <label>Email (*)</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="txt_billing_mobile" name="txt_billing_mobile" type="text"
                    value="<?php echo e($order->receiverphone); ?>" readonly />
            </div>
            <div class="form-group">
                <label>Địa chỉ giao hàng (*)</label>
                <input class="form-control" id="txt_billing_addr1" name="txt_billing_addr1" type="text"
                    value="<?php echo e($order->shipaddress); ?>" readonly />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <input class="form-control" id="txt_inv_mobile" name="txt_inv_mobile" type="hidden"
                    value="<?php echo e($order->receiverphone); ?>" />
            </div>
...
<?php echo $__env->make('customer.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /workspaces/codespaces-blank/PureHealthTTLaravelEC/resources/views/customer/checkout.blade.php ENDPATH**/ ?>