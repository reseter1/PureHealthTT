                    ...
                    <div class="product-details-images slider-navigation-1 slick-initialized slick-slider">
                        <div aria-live="polite" class="slick-list draggable">
                            <div class="lg-image slick-slide slick-current slick-active" data-slick-index="0"
                                ...
                                style="width: 470px;">
                                <a class="popup-img venobox vbox-item" href="<?php echo e($product->picturelink); ?>"
                    ...
                    <div class="product-info">
                        ...
                        <div class="rating-box pt-20">
                            <ul class="rating rating-with-review-item">
                                <?php for($i = 1; $i <= 5; $i++): ?> <?php if($i <=$avrgProduct[$product->
                                    productcode]): ?>
                    ...
                    <ul class="nav li-product-menu">
                        ...
                        <li><a style="font-family: 'Quicksand', sans-serif;" data-toggle="tab" href="#reviews"
                                class="active show"><span>Đánh giá của người
                                    mua (<?php echo e($assessments->count()); ?>)</span></a></li>
                    </ul>
                </div>
                ...
                <div class="product-reviews">
                    <div class="product-details-comment-block">
                        ...
                        <div class="comment-author-infos pt-25">
                            <span>Khách hành: <?php echo e($assessment->customer->username); ?></span>
                            <ul class="rating">
                                <?php for($i = 1; $i <= 5; $i++): ?> <?php if($i <=$assessment->rate): ?>
                                    <li><i class="fa fa-star-o"></i></li>
                                    <?php else: ?>
                                    <li class="no-star"><i class="fa fa-star-o"></i></li>
                                    <?php endif; ?>
                            ...
                            <em>Đăng ngày: <?php echo e($assessment->created_at); ?></em>
                            <p><?php echo e($assessment->content); ?></p>
                        </div>
                                        ...
                                        <div class="modal-inner-area row">
                                            <div class="col-lg-6">
                                                <div class="li-review-product">
                                                    <img src="<?php echo e($product->picturelink); ?>" alt="Li's Product">
                                                    <div class="li-review-product-desc">
                                                        <p class="li-product-name">Sản phẩm: <?php echo e($product->productname); ?>

                                                        </p>
                                                        <p>
                                                            <span>Mô tả: <br> <?php echo nl2br($product->description); ?></span>
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="feedback">
                                                            ...
                                                            <form id="form_post_assessment">
                                                                ...
                                                                <div class="feedback-input">
                                                                    <p class="feedback-form-author">
                                                                        ...
                                                                        <input id="author" name="username"
                                                                            value="<?php echo e(Auth::check() ? Auth::user()->username : ''); ?>"
                                                                ...
                                                                <input type="hidden" name="productcode"
                                                                    value="<?php echo e($product->productcode); ?>">
                                                                <input type="hidden" name="customercode"
                                                                    value="<?php echo e(Auth::check() ?Auth::user()->usercode : ''); ?>">
                                                            </form>
                                                        </div>
                                                    </div>
            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="product-active owl-carousel">
                        <?php $__currentLoopData = $sameTypeProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-wrap">
                                <div class="product-image">
                                    ...
                                    <?php if(now()->diffInDays(\Carbon\Carbon::parse($product->created_at)) < 3): ?> <span
                                ...
                                <div class="product_desc">
                                    <div class="product_desc_info">
                                        ...
                                        <h4><a class="product_name"
                                                href="/customer/product-details/<?php echo e($product->productcode); ?>"><?php echo e($product->productname); ?>
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-6">
                        <div class="product-details-view-content pt-60">
                            <div class="product-info">
                                ...
                                <div class="rating-box pt-20">
                                    <ul class="rating rating-with-review-item">
                                        <?php for($i = 1; $i <= 5; $i++): ?> <?php if($i <=$avrgRateSameTypeProduct[$product->
                                            productcode]): ?>
                                            <li><i class="fa fa-star-o"></i></li>
                                            <?php else: ?>
                                            <li class="no-star"><i class="fa fa-star-o"></i></li>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('fixjQuery'); ?>
<script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('customer.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /workspaces/codespaces-blank/PureHealthTTLaravelEC/resources/views/customer/single_product.blade.php ENDPATH**/ ?>